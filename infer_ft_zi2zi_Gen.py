...
def main(d_name, n_layer):
    ...
    # tx = transforms.Resize((20,), interpolation=InterpolationMode.BICUBIC)
    ...
    # load_path = '/Users/ro/Documents/team9/zi2zi_generator.pth'
    # a = torch.load(load_path)
    save_filename = 'ft_zi2zi_gen3.pth'
    save_path = os.path.join('/Users/yongchanchun/PycharmProjects/fake_detection/', save_filename)

    # state_dict는 모델의 파라미터가 저장되어 있음
    ...
    for i, data in enumerate(dataloader):
        ...
        #     images = tx(images)
        out_feature = ft_model.forward(images)
    ...
    fig = ax.get_figure()
    fig.savefig(d_name+"_fig_ft_zi2zi_Gen_last_2048_S"+str(size)+'.png')
